...
from .views import EventoCadastro, EventoList, EventoDelete, EventoUpdate, EventoDetail, EventoMensal, EventoSempre, registrar_token
...
urlpatterns = [
    ...
    path('registrar_token/', registrar_token, name='registrar_token'),
]
